...
//
const BotName = 'CalvinPdg BotZ🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/calvin_rese'; // Nama Instagramlu cok
const whatsapplu = '6017-924-9791'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/FpiOYucaMvxJMvCfXvaHEB'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/FpiOYucaMvxJMvCfXvaHEB'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Calvin Pahlevi`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Calvin Pahlevi`)
})
